var gameState = "begin", score = 0, life = 3, life1, portal1, portal2, ghostHouse1;
var ghostHouse2, ghostHouse3, ghostHouse4, life2, life3, touched = 0, ghostHouse5;
...
var pacmanRightA, pacmanLeftA, pacmanUpA, pacmanDownA, livesI, ghost1I, ghost2I;
...
var ghost4Turn5, a = 0, b = 0, c = 0, ababav = 0;

function preload() {
    wall1I = loadImage("../MAKE-YOUR-OWN-GAME---4/Images/Wall/Wall.png");
    wall2I = loadImage("../MAKE-YOUR-OWN-GAME---4/Images/Wall/Wall2.png");
    wall3I = loadImage("../MAKE-YOUR-OWN-GAME---4/Images/Wall/Wall3.png");
    wall4I = loadImage("../MAKE-YOUR-OWN-GAME---4/Images/Wall/Wall4.png");
    wall5I = loadImage("../MAKE-YOUR-OWN-GAME---4/Images/Wall/Wall5.png");
    wall6I = loadImage("../MAKE-YOUR-OWN-GAME---4/Images/Wall/Wall6.png");
    wall7I = loadImage("../MAKE-YOUR-OWN-GAME---4/Images/Wall/Wall7.png");
    wall8I = loadImage("../MAKE-YOUR-OWN-GAME---4/Images/Wall/Wall8.png");
    wall9I = loadImage("../MAKE-YOUR-OWN-GAME---4/Images/Wall/Wall9.png");
    wall10I = loadImage("../MAKE-YOUR-OWN-GAME---4/Images/Wall/Wall10.png");
    wall11I = loadImage("../MAKE-YOUR-OWN-GAME---4/Images/Wall/Wall11.png");
    wall12I = loadImage("../MAKE-YOUR-OWN-GAME---4/Images/Wall/Block.png");

    cherryI = loadImage("../MAKE-YOUR-OWN-GAME---4/Images/Cherry.png");
...
function draw() {
    ...
    if (gameState === "start") {
        ...
        if (pacman.isTouching(cherry) && life == 0) {
            life++;
            cherry.destroy();
        ...
        else if (pacman.isTouching(cherry) && life == 1) {
            life++;
            cherry.destroy();
        ...
        else if (pacman.isTouching(cherry) && life == 2) {
            life++;
            cherry.destroy();
